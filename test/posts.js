    ...
    describe("renderLatex", () => {
        ...
        it("should render inline latex into mathml", () => {
            ...
            const callback = (err, postData) => {
                ...
                const expectedOutput =
                    '<span class="katex"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>β</mi><mo>=</mo><mn>10</mn></mrow><annotation encoding="application/x-tex">\\beta = 10</annotation></semantics></math></span>';
        ...
        it("should render block latex into mathml", () => {
            ...
            const callback = (err, postData) => {
                assert.ifError(err);
                const expectedOutput =
                    '<span class="katex"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>β</mi><mo>=</mo><mn>10</mn></mrow><annotation encoding="application/x-tex">\\beta = 10</annotation></semantics></math></span>';
                assert.equal(postData.content, expectedOutput);
            };
